...
GLIB_AVAILABLE_IN_ALL gint g_type_add_instance_private(GType class_gtype, gsize private_size);
...
GLIB_AVAILABLE_IN_ALL void g_type_class_adjust_private_offset(gpointer g_class, gint *private_size_or_offset);
